...
func NewMCPServer(cfg *config.Config) (*MCPServer, error) {
	...
	transcriptOps := transcript.NewOperationsWithBaseURL(cfg.OpenAIKey, cfg.WhisperBaseURL, ffmpegMgr)
	...
	s.addTool(mcp.Tool{
		...
		InputSchema: mcp.ToolInputSchema{
			...
			Properties: map[string]interface{}{
				...
				"whisperBaseURL": map[string]interface{}{
					"type":        "string",
					"description": "Optional OpenAI-compatible base URL for Whisper transcription only",
				},
