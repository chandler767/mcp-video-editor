    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-card border border-border rounded-lg shadow-xl w-full max-w-2xl mx-4">
        ...
        <div className="border-b border-border px-6 py-4 flex items-center justify-between">
          ...
          <Tooltip content="Close about dialog">
            <button
              onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex items-center justify-center space-x-6 pt-4">
            ...
            <Tooltip content="Report bugs or request features">
              <a
            ...
            <Tooltip content="Read user guide and API docs">
              <a
        ...
        <div className="border-t border-border px-6 py-4 bg-secondary/30">
          <Tooltip content="Close and return to editor">
            <button
              onClick={onClose}
